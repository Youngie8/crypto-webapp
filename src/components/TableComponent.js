  ...
  return (
    <>
                        ...
                        cryptoData.map(data => {
                            return(
                                <tr key={data.id} className='text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0'>
                                    ...
                                    <td className={ data.market_cap_change_percentage_24h > 0 ? "text-green py-4":'text-red py-4'}>{Number(data.market_cap_change_percentage_24h).toFixed(4)}%</td>
                                    <td className={ data.price_change_percentage_1h_in_currency > 0 ? "text-green py-4":'text-red py-4'}>{Number(data.price_change_percentage_1h_in_currency).toFixed(3)}%</td>
                                    <td className={ data.price_change_percentage_24h_in_currency > 0 ? "text-green py-4":'text-red py-4'}>{Number(data.price_change_percentage_24h_in_currency).toFixed(3)}%</td>
                                    <td className={ data.price_change_percentage_7d_in_currency > 0 ? "text-green py-4":'text-red py-4'}>{Number(data.price_change_percentage_7d_in_currency ).toFixed(3)}%</td>
        ...
        <div className='flex items-center justify-between mt-4 capitalize h-[2rem]'>
            <span>Data provided by <a className='text-cyan' href='http://www.coingecko.com' target='_blank' rel='noopener'>coinGecko</a></span>
            <Pagination />
        </div>
    </>
  )
